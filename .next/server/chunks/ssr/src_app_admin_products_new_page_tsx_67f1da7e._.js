...
function NewProductPage() {
    ...
    async function handleSubmit(e) {
        e.preventDefault();
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"])("/api/admin/parts", {
            method: "POST",
            body: JSON.stringify({
                sku,
                name,
...
//# sourceMappingURL=src_app_admin_products_new_page_tsx_67f1da7e._.js.map