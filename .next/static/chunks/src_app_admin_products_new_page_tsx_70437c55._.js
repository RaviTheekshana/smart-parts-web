...
function NewProductPage() {
    ...
    async function handleSubmit(e) {
        e.preventDefault();
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])("/api/admin/parts", {
            method: "POST",
            body: JSON.stringify({
                sku,
                name,
...
_s(NewProductPage, "k8c5JjgJOXcKrWpv5Cff5tNeAVQ=", false, function() {
    return [
...
//# sourceMappingURL=src_app_admin_products_new_page_tsx_70437c55._.js.map