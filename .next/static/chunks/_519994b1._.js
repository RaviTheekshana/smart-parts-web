...
function RegisterPage() {
    ...
    const [acceptTos, setAcceptTos] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // default true for demo; toggle as you like
    ...
    async function handleSubmit(e) {
        ...
        setIsLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])("/api/auth/register", {
                method: "POST",
                body: JSON.stringify({
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])("/api/auth/login", {
                method: "POST",
                body: JSON.stringify({
                    email: formData.email,
                    password: formData.password
...
_s(RegisterPage, "rc8/zHz2ah2/2hPwQ46j+ZL6Bgo=", false, function() {
    return [
...
//# sourceMappingURL=_519994b1._.js.map